...
'''
    ...
    from https://github.com/opencv/opencv/blob/4.x/samples/python/drawing.py
    This seems to be pure OpenCV and Python
    '''
...
if __name__ == '__main__':
    #print(__doc__) #This prints the ''' docs ''' at the top of this doc
